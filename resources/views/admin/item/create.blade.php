...
@section('content')
    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <div class="p-3 rounded mb-3 bg-light d-flex align-items-center"><a href="{{route('admin.item.list')}}" class="text-decoration-none">List page</a><span><i class="fa-solid fa-chevron-right mx-2"></i>Add Items</span></div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-body bg-light">
                            <form action="{{route('admin.item.create')}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('itemName')}}" id="cc-pament" name="itemName" type="text"
                                        ...
                                        @enderror
                                        <label for="categoryId" class="control-label fw-semibold  mb-2">Select
                                            Category*</label>
                                        <select name="categoryId" id=""
                                            class="form-select mb-2 @error('categoryId') is-invalid @enderror">
                                            <option value="">Choose Category</option>
                                            @foreach ($category as $c)
                                                <option value="{{ $c->id }}"
                                                    @if (old('categoryId') == $c->id) selected @endif>{{ $c->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('categoryId')
                                        ...
                                        <input id="cc-pament" name="itemPrice" value="{{ old('itemPrice') }}" type="number"
                                        ...
                                        <textarea name="itemDesc"  id="itemDesc" class="form-control mb-2 @error('itemDesc') is-invalid @enderror" placeholder="Enter Item Description...">{{old('itemDesc')}}</textarea>
                                        @error('itemDesc')
                                            <span class="invalid-feedback">{{$message}}</span>
                                        @enderror
                                        ...
                                        @error('itemImage')
                                            <span class="invalid-feedback">{{$message}}</span>
                                        @enderror
                                        <p class="mt-2 mb-1 fw-semibold">Status</p>
                                        <div class="form-check">
                                            <input name="itemStatus" class="form-check-input" type="checkbox"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="ownerName" class="control-label fw-semibold mb-2">Owner Name*</label>
                                        <input value="{{old('ownerName')}}" id="cc-pament" name="ownerName" type="text"
                                        ...
                                        <input id="cc-pament" name="ownerNumber" value="{{ old('ownerNumber') }}" type="number"
                                        ...
                                        <textarea name="ownerAddress"  id="" cols="" rows="2" class="form-control mb-2 @error('ownerAddress') is-invalid @enderror" placeholder="Enter Owner Address...">{{old('ownerAddress')}}</textarea>
                                        <div class="d-none">
